...
- (void)saveUrlAsPdf:(NSURL *)url toFile:(NSString *)file {
	...
	if ([self.webView.configuration respondsToSelector:@selector(setSuppressesIncrementalRendering:)]) {
		[self.webView.configuration setSuppressesIncrementalRendering:YES];
	}
